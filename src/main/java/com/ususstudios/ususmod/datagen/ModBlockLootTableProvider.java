...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
	...
	protected void generate() {
		...
		dropSelf(ModBlocks.HEMATITE_PROCESSOR.get());
		
		add(ModBlocks.HEMATITE_ORE.get(),
				block -> createMultipleOreDrops(ModBlocks.HEMATITE_ORE.get(), ModItems.RAW_HEMATITE.get(), 2, 4));
		add(ModBlocks.HEMATITE_DEEPSLATE_ORE.get(),
				block -> createMultipleOreDrops(ModBlocks.HEMATITE_DEEPSLATE_ORE.get(), ModItems.RAW_HEMATITE.get(),
						2, 5));
	}
